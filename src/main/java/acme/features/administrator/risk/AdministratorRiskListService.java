...
public class AdministratorRiskListService extends AbstractService<Administrator, Risk> {
	...
	public void load() {
		...
		objects = this.administratorRiskRepository.findAllRisks();
	...
	public void unbind(final Risk object) {
		...
		payload = String.format("%s; %s; %s; %s", object.getDescription(), object.getImpact(), object.getProbability(), object.getOptionalLink());
